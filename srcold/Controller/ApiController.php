...
#[Route('/api/mobile/GetLesCategories/{parentId}', name: 'api_categories_by_parent')]
public function getCategoriesByParentId(int $parentId, CategorieRepository $categorieRepository): JsonResponse
{
    $categories = $categorieRepository->findBy(['lacategorieParent' => $parentId]);
...
#[Route('/api/mobile/GetLesProduits/{categorieId}', name: 'api_produits_par_categorie')]
public function getProduitsParIdCategorie(int $categorieId, ProduitsRepository $produitsRepository): JsonResponse
{
    $produits = $produitsRepository->findBy(['laCategorie' => $categorieId]);
